...
Plugin URI: https://github.com/m266/php-widget
...
$myUpdateChecker = Puc_v4_Factory::buildUpdateChecker('https://github.com/m266/php-widget', __FILE__, 'php-widget');
...
// Frontend-Design Funktionen
  public function __construct() {
    ...
    $widget_ops = array('classname' => 'widget_execphp', 'description' => __('Beliebiger PHP-Code. ', 'php-widget'));
    $control_ops = array('width' => 400, 'height' => 350);
    parent::__construct('execphp', __('PHP', 'php-widget'), $widget_ops, $control_ops);
  }
    ...
    ?>
      <div class="execphpwidget"><?php echo $instance['filter'] ? wpautop($text) : $text; ?></div>
                    ...
                    // Erstellt das Kontroll-Formular im WP-Dashboard
                        ...
                        ?>
    <p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'php-widget'); ?></label>
    <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></p>

    <textarea class="widefat" rows="16" cols="20" id="<?php echo $this->get_field_id('text'); ?>" name="<?php echo $this->get_field_name('text'); ?>"><?php echo $text; ?></textarea>

    <p><input id="<?php echo $this->get_field_id('filter'); ?>" name="<?php echo $this->get_field_name('filter'); ?>" type="checkbox" <?php checked(isset($instance['filter']) ? $instance['filter'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id('filter'); ?>"><?php _e('Automatisch Abs&auml;tze hinzuf&uuml;gen.', 'php-widget'); ?></label></p>
                    <?php
                  }
